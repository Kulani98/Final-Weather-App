...
public class Login extends AppCompatActivity {
    ...
    Button uLoginBtn;
    TextView uCreateBtn, forgotLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uEmail = findViewById(R.id.password);
        uPassword = findViewById(R.id.cpassword);
        progressBar = findViewById(R.id.progressBar2);
        fAuth = FirebaseAuth.getInstance();
        uLoginBtn = findViewById(R.id.loginBtn);
        uCreateBtn = findViewById(R.id.createText);
        forgotLink = findViewById(R.id.fogotPassword);
        ...
        uLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password.length() < 6) {
                    uPassword.setError("Password Not Valid");
                    return;
                }
